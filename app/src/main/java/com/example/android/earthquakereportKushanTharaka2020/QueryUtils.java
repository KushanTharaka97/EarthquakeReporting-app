...
public final class QueryUtils {
    ...
    public static ArrayList<DetailsView> extractEarthquakes() {
        ...
        ArrayList<DetailsView> earthquakes = new ArrayList<>();
        ...
        try {
            ...
            JSONObject objectExtract = new JSONObject(SAMPLE_JSON_RESPONSE);
            JSONArray featuresDetect = objectExtract.getJSONArray("features");

            for (int i = 0;i<featuresDetect.length();i++){
                ...
                earthquakes.add(new DetailsView(mag,place, dateToDisplay));
            }
